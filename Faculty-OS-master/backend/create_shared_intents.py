...
with open("c:/Users/GURU GAYATHRI/Downloads/Faculty-OS-master/Faculty-OS-master/backend/core/shared_intents.py", "w", encoding="utf-8") as f:
    f.write(template)

print("Created backend/core/shared_intents.py")
